...
cl = LINETCR.LINE()
cl.login(token="Enc7tng4VbOwv61fWmF4.1URSVcJIcR9zzYAVPUCMva.PJp1wwcRHtWrSvU3Nb2+sbrFH2uN1kHZ0KPDdkvcT/U=")
cl.loginResult()

#kt = LINETCR.LINE()
#kt.login(token="EnwIxaxump1fca9MS5La.O5l+/QmuY6G/wgyx2fh9EG.3sHP9e07OhyT73zuvc+rBJXaJnjHT2WHajSsrFToCCY=")
#kt.loginResult()

#ks = LINETCR.LINE()
#ks.login(token="EnM74Hx5IkU21QFpAQea.ESh/DaAafbu/jCokqOKjQG.nYZm1YhZ+D9AFOCtwhi9zEfNN7jJgqiU7YMYEJFjrAc=")
#ks.loginResult()

#ki = LINETCR.LINE()
#ki.login(token="EnOc7bHxyCrCMv8sPCa2.DRDMrW6Eb7ojiQmvnu0ayG./NdUbZXVhNeErE0hfCfxsxwObHGN2+OZRGn5eWdk0So=")
#ki.loginResult()

#kk = LINETCR.LINE()
#kk.login(token="En0S1I5oRwmFMG1oq931.29UyiFDXEP3fADGKEOt/0q.6QcV0Qe6XMLcEy3VmRC/TFlts9VwnAq6djldC5auGyk=")
#kk.loginResult()

#kc = LINETCR.LINE()
#kc.login(token="EnSdskifrDp9b4LfrsSe.bXgVtu5kSGoBSNRPtLnC+G.c5h7JbNRJCmnJ573EoMnZIT8Ib8PzDmYb5Ihj+ceHts=")
#kc.loginResult()
...
admin = ["ud6eaecbc28e20abf596726afa6e72654"]
owner = ["ud6eaecbc28e20abf596726afa6e72654"]
wait = {
    'contact':False,
    'autoJoin':True,
